...
function ic_duplicate_product() {
	if ( isset( $_GET[ 'ic-duplicate' ] ) && isset( $_GET[ 'ic_duplicate_product_nonce' ] ) && wp_verify_nonce( $_GET[ 'ic_duplicate_product_nonce' ], 'ic_duplicate_product' ) && current_user_can( 'publish_products' ) ) {
		global $wpdb;
		// Get variables
