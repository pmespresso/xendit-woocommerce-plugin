...
return apply_filters( 'wc_xendit_settings',
	array(
		...
		'request_payment_api' => array(
			'title'       => __( 'Payment Request API', 'woocommerce-gateway-xendit' ),
			'label'       => __( 'Enable Payment Request API', 'woocommerce-gateway-xendit' ),
			'type'        => 'checkbox',
			'description' => __( 'If enabled, users will be able to pay using the Payment Request API if supported by the browser.', 'woocommerce-gateway-xendit' ),
			'default'     => 'no',
			'desc_tip'    => true,
		),
		'saved_cards' => array(
			'title'       => __( 'Saved Cards', 'woocommerce-gateway-xendit' ),
			'label'       => __( 'Enable Payment via Saved Cards', 'woocommerce-gateway-xendit' ),
			'type'        => 'checkbox',
			'description' => __( 'If enabled, users will be able to pay with a saved card during checkout. Card details are saved on xendit servers, not on your store.', 'woocommerce-gateway-xendit' ),
			'default'     => 'no',
			'desc_tip'    => true,
		),
		'logging' => array(
